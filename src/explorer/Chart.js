...
const Chart = ( { data: { loading, error, coin }, theme, name, ...props }={} ) => {
  ...
  return <Line title={coin.name} name={name} subtitle={coin.price_usd} series={{ [coin.symbol]: series }} colors={[color]} />
}
